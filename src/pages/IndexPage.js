...
const Index = (props) => {
    ...
    const headerCollapse = {
        ...
        right: <span>
                    ...
                    <a href={'/shop/' + locale + '/cart'} className="link nav-cornflower" style={{ marginLeft: "2px", verticalAlign: "bottom"}}>
                        <span>
    ...
    return (
        <>
            <div>
                <Rodal visible={visibleLoginModal} onClose={hideLoginModal} height="360">
                    <LoginModal />
                </Rodal>
